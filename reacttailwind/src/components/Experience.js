...
const Experience=()=>{
    return (
  <section className="mb-12 lg:mb24">
    <div className="container mx-auto">
        ...
        <div className="flex-1 flex flex-col items-start justify-center mt-6 lg:mt-0" data-aos="fade-left" data-aos-offset="400">
            <h2 className="text-3xl font-bold mb-6">New Experience</h2>
            <p className="font-secondary mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
